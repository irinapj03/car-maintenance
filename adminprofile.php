                ...
                <?php
                    ...
                    try {
                        if ($_SERVER['REQUEST_METHOD'] == "POST") {
                            ...
                            $stmt = mysqli_prepare($con, "UPDATE admin SET name = ?, ic_number = ?, user_email = ?, user_phone = ?, gender = ?, user_age = ?, user_password = ? WHERE id = ?");
                ...
                ?>
                    <form method="post" enctype="multipart/form-data" onsubmit="return checkPassword(this);">
                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                            <div class="input-box">
                                <label>Name:</label>
                                <div class="label"><input type="text" placeholder="Name" name="name" value="<?php echo $row['name']?>" required></div>
                            </div>
                            <div class="input-box">
                                <label>IC Number:</label>
                                <div class="label"><input type="text" placeholder="IC Number" name="ic_num" value="<?php echo $row['ic_number']?>" required></div>
                            </div>
                            <div class="input-box">
                                <label>Email:</label>
                                <div class="label"><input type="text" placeholder="Email" name="user_email" value="<?php echo $row['user_email']?>" required></div>
                            </div>
                            <div class="input-box">
                                <label>Phone Number:</label>
                                <div class="label"><input type="text" placeholder="Phone Number" name="phone_number" value="<?php echo $row['user_phone']?>" required></div>
                            </div>
                            <div class="input-box">
                                <label>Age:</label>
                                <div class="label"><input type="number" name="age" placeholder="Age" value="<?php echo $row['user_age']?>" required></div>
                            </div>
                            <div class="input-box">
                                <label>Gender:</label>
                                <div class="label"><select name="gender">
