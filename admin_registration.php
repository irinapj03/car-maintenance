    ...
    <div class="wrapper-col">
        <form method="post" enctype="multipart/form-data" onsubmit="return checkPassword(this) && checkPositive(this);">
            <h2>Admin Registration</h2>
                ...
                <div class="input-box">
                    <input type="text" placeholder="IC Number" name="ic_num" required>
                </div>
                <div class="input-box">
                        ...
                        if ($num_rows_admin > 0) {
                            ...
                            if ($num_rows2_admin > 0) {
                                ...
                                if ($num_rows3 > 0) {
                                    ...
                                    $sql = "INSERT INTO admin (user_name, name, ic_number, user_email, user_phone, gender, user_age, user_password) VALUES ('$user_name', '$name', '$ic', '$user_email','$user_phone', '$user_gender', '$user_age', '$user_password')";
                                    ...
                                    if($check == 1) {
                                        echo '<script>alert("Successfully registered!");window.location.href="admin_list.php";</script>'; 
                                    }
