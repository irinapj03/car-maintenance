                ...
                <div class="wrapper-report">
                    <div class="wrapper-report-col">
                        <div class="monthly-report-header">
                            ...
                            <h4 class="monthly-report-subtitle">April</h4>
                        </div>
                        <div class="monthly-report-content-wrapper" >
                            <div class="monthly-report-content">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT SUM(amount) AS total_amount FROM payment WHERE MONTH(date) = '04'";
                                    ...
                                    if ($result) {
                                        ...
                                        echo '<div class="monthly-report-content-item-amount">Error retrieving data</div>'; 
                                    }
                            ...
                            <div class="monthly-report-content">
                                ...
                                <?php
                                    ...
                                    $sql2 = "SELECT COUNT(*) AS appointment_count FROM appointment WHERE MONTH(timestamp) = '04'";
